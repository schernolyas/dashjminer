...
public class BlockHeaderTemplateProducerTest {
    ...
    public void testProduceBlockHeaderTemplate() throws Exception {
        ...
        byte[] littleEndianNBits = ByteUtils.littleEndian(miningNotify.getEncodedNetworkDifficulty());
        ...
        System.out.println("littleEndian nBits: " + littleEndianNBits);
        assertArrayEquals(littleEndianNBits, resultNBits);
